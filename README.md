...
`${GOPATH}/src/github.com/AhhMonkeyDevs/discordbeat`
...
```
git remote set-url origin https://github.com/AhhMonkeyDevs/discordbeat
...
```
mkdir -p ${GOPATH}/src/github.com/AhhMonkeyDevs/discordbeat
git clone https://github.com/AhhMonkeyDevs/discordbeat ${GOPATH}/src/github.com/AhhMonkeyDevs/discordbeat
```
